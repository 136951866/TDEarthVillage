...
@property (nonatomic,strong) kHankBasicBlock block_refresh;
...
+ (void)showInView:(UIView *)aView refreshBlock:(kHankBasicBlock)block editHandle:(editFailLoadVIewBlock)aBlock{
...
+ (void)showInView:(UIView *)aView response:(id)response allData:(NSArray *)arrData refreshBlock:(kHankBasicBlock)blockRefresh editHandle:(editFailLoadVIewBlock)blockEdit{

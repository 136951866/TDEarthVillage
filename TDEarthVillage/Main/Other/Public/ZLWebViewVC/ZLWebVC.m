...
- (WKWebView *)wkWebView{
    if (!_wkWebView) {
        ...
        _wkWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, kHankNavBarHeight, SCREEN_WIDTH, SCREEN_HEIGHT-kHankNavBarHeight) configuration:Configuration];
...
-(UIBarButtonItem*)customBackBarItem{
    if (!_customBackBarItem) {
        _customBackBarItem = [UIBarButtonItem itemWithTarget:self action:@selector(customBackItemClicked) image:@"common_back" highImage:@"common_back"];
    }
...
- (UIProgressView *)progressView{
    if (!_progressView) {
        ...
        _progressView.progressTintColor = kThemeBlue;
    }
